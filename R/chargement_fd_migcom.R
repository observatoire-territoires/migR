...
#' @param anneeRP Millésime du recensement de la population (RP) de l'Insee. Peut prendre les valeurs "2008", "2013", "2014", "2015" ou "2016". Non renseigné si telechargement vaut TRUE.
...
#' FD_MIGCOM_2016 <- chargement_fd_migcom(anneeRP = "2016",  telechargement = TRUE, dossier_dest_TL = "./data")
#'
#' # Chargement du fichier txt MIGCOM disponible en local
#' FD_MIGCOM_2016 <- chargement_fd_migcom(chemin_FD = "./data/RP2016_MIGCOM_csv/FD_MIGCOM_2016.csv")
#' }
#'
#' @export
  ...
  if(telechargement %in% TRUE){
    ...
    liste_FD_MIGCOM <-
      tibble::tribble(
        ...
        "2016","https://www.insee.fr/fr/statistiques/4171543?sommaire=4171558", "https://www.insee.fr/fr/statistiques/fichier/4171543/contenu_RP2016_migcom.pdf","https://www.insee.fr/fr/statistiques/fichier/4171543/RP2016_migcom_csv.zip","RP2016_MIGCOM_csv","FD_MIGCOM_2016.csv",
        "2015","https://www.insee.fr/fr/statistiques/3566042?sommaire=3558417", "https://www.insee.fr/fr/statistiques/fichier/3566042/contenu_rp2015_migcom.pdf","https://www.insee.fr/fr/statistiques/fichier/3566042/rp2015_migcom_txt.zip","rp2015_migcom_txt","FD_MIGCOM_2015.txt",
        "2014","https://www.insee.fr/fr/statistiques/2866333?sommaire=2866354", "https://www.insee.fr/fr/statistiques/fichier/2866333/contenu_rp2014_migcom.pdf","https://www.insee.fr/fr/statistiques/fichier/2866333/rp2014_migcom_txt.zip","rp2014_migcom_txt","FD_MIGCOM_2014.txt",
        "2013","https://www.insee.fr/fr/statistiques/2409519?sommaire=2409559", "https://www.insee.fr/fr/statistiques/fichier/2409519/contenu_rp2013_migcom.pdf","https://www.insee.fr/fr/statistiques/fichier/2409519/rp2013_migcom_txt.zip","rp2013_migcom_txt","FD_MIGCOM_2013.txt",
        "2008","https://www.insee.fr/fr/statistiques/2408687?sommaire=2409062", "https://www.insee.fr/fr/statistiques/fichier/2408687/contenu_rp2008_migcom.pdf","https://www.insee.fr/fr/statistiques/fichier/2408687/rp2008_migcom_txt.zip","rp2008_migcom_txt","FD_MIGCOM_2008.txt")
    ...
    download.file(parametres_DL$url_txt,
                  destfile = paste0(dossier_dest_TL, "/",parametres_DL$nom_dossier, ".zip"),
                  method='auto')

    # dézipper fichiers
    unzip(paste0(dossier_dest_TL, "/",parametres_DL$nom_dossier, ".zip"),
          exdir=paste0(dossier_dest_TL, "/", parametres_DL$nom_dossier) )

    if (monet) {
      output <- Insee2MonetDB::Insee2MonetDB(csvfile = paste0(dossier_dest_TL, "/",parametres_DL$nom_dossier,"/",parametres_DL$nom_fichier))
      return(output %>% as.data.frame())
    }


    # lecture et import du fichier FD zippé
    output <- readr::read_delim(paste0(dossier_dest_TL, "/",parametres_DL$nom_dossier,"/",parametres_DL$nom_fichier),
