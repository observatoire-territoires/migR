...
author: "JG / MG / Observatoire des Territoires"
date: "`r Sys.Date()`"
...
Les concepts de population basées sur les données de détail fournies dans le fichier détail 'Migrations Résidentielles' du [RP 2014 (Insee)](https://www.insee.fr/fr/statistiques/2866333?sommaire=2866354#dictionnaire) sont définies comme suit :
...
Chacune de ces populations peut être ventilée selon :
 ...
 - la catégorie socio-professionelle de l'individu (Agriculteurs exploitants / Artisans, commeréants et chefs d'entreprise / Cadres et professions intellectuelles supérieures, etc...)
 - la tranche d'âge
...
La part d'entrants dans un territoire correspond à la part de la population entrante (i.e. résidente en France en N-1 mais hors du territoire considéré) au sein de la population résidente. Elle est égale au ratio entre la population entrante et la population résidente et est exprimé en %.
